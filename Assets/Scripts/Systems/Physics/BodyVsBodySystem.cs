...
public partial struct BodyVsBodySystem : ISystem
{
    ...
    struct FindBodyVsBodyProcessor : IFindPairsProcessor
    {
        ...
        {
            ref readonly RigidBody rigidBodyA = ref bodyLookup.GetRefRO(result.entityA).ValueRO;
            ref readonly RigidBody rigidBodyB = ref bodyLookup.GetRefRO(result.entityB).ValueRO;
